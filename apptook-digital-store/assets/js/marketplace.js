(function () {
	...
	function initProfileDropdown(root) {
		...
		var wrap = root.querySelector('.st-nav__profile-wrap');
	...
	function initMobileNav(root) {
		var trigger = root.querySelector('.st-nav__mobile-trigger');
		var panel = root.querySelector('#apptook-st-mobile-menu');
		if (!trigger || !panel) {
			return;
		}
