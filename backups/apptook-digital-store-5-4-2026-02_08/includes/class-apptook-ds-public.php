...
final class Apptook_DS_Public {
	...
	private function render_marketplace( array $atts ): string {
		$html_path = APPTOOK_DS_PATH . 'assets/html/stitch-full.html';
		if ( file_exists( $html_path ) ) {
			$contents = file_get_contents( $html_path );
				...
				<div class="st-nav__inner">
					...
					<div class="st-nav__right">
						...
						<div class="st-nav__auth" id="apptook-st-auth-buttons">
							...
							<button type="button" class="st-nav__btn-primary st-nav__open-register"><?php esc_html_e( 'Sign Up', 'apptook-digital-store' ); ?></button>
							<?php endif; ?>
						</div>
						<?php endif; ?>
					</div>
